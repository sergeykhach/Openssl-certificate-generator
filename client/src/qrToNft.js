...
export default async function QrCodeToNFT(){
	...
	let resQr = await fetch("https://khachoyan.com/nft", {
		...
		document.getElementById('ipfs_URI').innerHTML = ("After transaction confirmed, find saved NFT on: " + "https://testnets.opensea.io/account");
		  
		let svg_norm = kayf.ipfsURI_CertNFT;
